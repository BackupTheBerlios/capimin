...
def ShowSend3(user,changepage="change.cgi",formname=""):    
    ...
    print '   <th><b>%s</b></th><th>%s</th><th>%s</th><th>%s</th><th>%s</th>' %\
          (webmin.hlink("?","sendlist"),webmin.hlink(webmin.text['index_id'],"sendlist"),
           webmin.hlink(webmin.text['index_dialstring'],"sendlist"),
           webmin.hlink(webmin.text['index_addressee'],"sendlist"),webmin.hlink(webmin.text['index_tries'],"sendlist"))
    
    print '   <th>%s</th><th>%s</th>\n </tr>' % (webmin.hlink(webmin.text['index_nexttry'],"sendlist"),
                                                 webmin.hlink(webmin.text['index_subject'],"sendlist"))
    ...
    print '&nbsp;&nbsp;%s' % webmin.hlink(webmin.text['capimin_help'],"sendlist")
    # submit buttons
    print '<br><br>'
